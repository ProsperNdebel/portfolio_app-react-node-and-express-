  ...
  return (
    <div>
      <ScreenHeading
        ...
        subHeading={"Some projects I have worked on"}
      />
        ...
        {/*<div className="container">
          <div className="row">
            <OwlCarousel
              ...
              {...options}
            >
              <div calssName="card-wrapper">
                <img src={mike} alt="img" className="projectImg" />
                {/* <div>
                  <h4>IP Address Tracker</h4>
                  <div>
                    <Link>
                      <img src={lady} className="visitSite" alt="img" />
                    </Link>
                    <img src={githublink} className="githubLink" alt="icon" />
                  </div>
                </div> 
              </div>
